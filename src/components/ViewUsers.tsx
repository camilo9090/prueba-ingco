  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto mt-5 bg-gray-700 p-10 rounded-lg shadow-md text-center flex justify-center gap-10 items-center">
        ...
        <Link
          to="/CreateUSer"
          className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold uppercase p-3 mt-5 inline-flex items-center gap-2 rounded-lg transition duration-200"
        >
          <UserIcon height={30} />
          Agregar un Usuario
        </Link>
      ...
      <footer className="bg-gray-800 text-center p-5 text-white font-bold">
